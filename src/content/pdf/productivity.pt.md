...
![](the-opsec-bible/docs/assets/productivity.png)
...
Que palavra intimidadora, não é? O niilismo sempre foi associado à negatividade desde o seu início, afinal ele trata do "Nada". No entanto, como você verá, ele não deve ser temido; **pelo contrário, o niilismo é essencial para a sua própria saúde mental.**

## O Ato de Rejeitar Algo



![](the-opsec-bible/docs/productivity/nihilism-introduction/image.png)
...
Essencialmente, **o niilismo é essencialmente o ato de rejeitar algo.** Isso é perfeito para nós, porque há MUITAS coisas que precisamos rejeitar hoje em dia, dado o quanto de porcaria é bombardeada sobre todos por fontes centralizadas de mídia.

Hoje em dia, você TEM DE rejeitar muita porcaria diariamente; **o niilismo não é apenas uma ideia elegante, é uma prática real que você precisa implementar na sua vida diária para permanecer mentalmente são.**
...
![](the-opsec-bible/docs/productivity/nihilism-introduction/image-1.png)



Como veremos no [próximo tutorial](the-opsec-bible/docs/productivity/nihilism/index.md), a sua mente é o seu templo sagrado. Você quer mantê-la limpa para poder usá-la em seu potencial máximo.
...
A questão é que você muito provavelmente não conseguirá apreciar os aspectos mais sutis do templo sagrado se deixar sujeira na entrada. **Você precisa mantê-lo livre de distrações para conseguir preservar a sua santidade**.
...
![](the-opsec-bible/docs/productivity/nihilism-introduction/image-2.png)
...
![](the-opsec-bible/docs/productivity/nihilism-introduction/image-3.png)
...
![](the-opsec-bible/docs/productivity/nihilism-introduction/image-5.png)
...
O mesmo vale para a sua própria mente. **Se você está deixando suas compulsões, crenças e identidades se acumularem com o tempo, você também é um acumulador.**

Você está no seu próprio caminho. Você é o problema na sua vida. Você é a única fonte de problemas reais na sua vida. **Você é o único que precisa mudar para que as coisas melhorem.** Não procure em outro lugar; o problema está dentro, portanto olhe para dentro e aplique a solução dentro.
...
**A solução real são as afirmações negativas**, porque é exatamente o ato de rejeitar algo que estamos buscando. No nosso caso de uso, estamos empregando mantras para rejeitar compulsões, crenças e identidades.

Com repetição suficiente, **você perceberá que esses mantras são ferramentas para reescrever efetivamente a forma como você pensa**, e eles bastam para desfazer compulsões, vícios, crenças e identidades, para restaurar a sua clareza mental e preservá-la efetivamente.
...
![](the-opsec-bible/docs/productivity/the-poison-of-modern-times/matrix.jpeg)
...
O único problema é que existe uma crença falsa perpetuada por esses governos, **a crença falsa de que a realização da vida de alguém vem de fora.** A partir dessa única crença falsa, todos na sociedade foram conduzidos pelo caminho de incontáveis vícios, compulsões, crenças falsas e identidades indesejadas.



![](the-opsec-bible/docs/productivity/the-poison-of-modern-times/0.png)
...
**A realidade é que governos só se importam em permanecer no poder.** Mas, para fazer isso, precisam propagar seu veneno direto nas mentes das incontáveis massas sobre as quais pretendem governar.
...
![](the-opsec-bible/docs/productivity/the-poison-of-modern-times/prison.jpg)



Então, para reforçar a aceitação da sua existência, eles implementam o sistema de votação, no qual as massas recebem a ilusão de escolha (que sempre leva ao mesmo resultado de serem governadas por tiranos), **para tentar empurrar a crença falsa de que as massas escolheram esse governo**



![](the-opsec-bible/docs/productivity/the-poison-of-modern-times/choice.png)



Esses múltiplos partidos políticos empregam a identificação como seu catalisador; tentam fazer as massas se identificarem com suas mensagens, porque **é ao fazer as pessoas se identificarem com algo que essas pessoas começam a acreditar nas mentiras deles.**



![](the-opsec-bible/docs/productivity/the-poison-of-modern-times/richvspoor.png)
...
![](the-opsec-bible/docs/productivity/the-poison-of-modern-times/coalmine.png)



**Destruir o mundo inteiro em busca de lucro** é o destino final da sociedade como a conhecemos, e as corporações são o motor que está nos levando até lá.

Nessa busca, as corporações servem a muitos propósitos, o que é acelerado principalmente pela [centralização da internet](the-opsec-bible/docs/opsec/clearnet-vs-darknet/index.md), onde elas propagam propaganda em todo lugar que conseguem, ao mesmo tempo em que facilitam a passagem dessa mesma propaganda ao aumentar e diminuir artificial e intencionalmente a visibilidade e a descobribilidade de cada pessoa a pedido de governos.
...
![](the-opsec-bible/docs/productivity/the-poison-of-modern-times/propaganda.png)



Mesmo os chamados jornalistas independentes não são exceção a essa corrupção disseminada.

Tudo gira em torno de obter aquela moeda estatal extra, a cenoura do lucro e o bastão de permanecer pobre, irrelevante e silenciado. **É por isso que há tanta corrupção no mundo**
...
Sem mencionar que, para continuar agarrando a sua atenção, nada está fora dos limites. Isso é conhecido como [a guerra contra a atenção,](https://lichess.org/@/BenjiPortheault/blog/the-war-on-attention/zhrVS53D)



![](the-opsec-bible/docs/productivity/the-poison-of-modern-times/scvalues.png)
...
![](the-opsec-bible/docs/productivity/the-poison-of-modern-times/cringe.png)



Tudo é feito para que você seja fisgado a clicar no conteúdo sem valor deles (sim, [bitcoin não tem valor](https://www.youtube.com/watch?v=YTTac2XjyFY)). Tudo isso para que você veja anúncios forçados sobre você pelo YouTube, para que eles possam gerar lucro para si mesmos e, por extensão, o """criador de conteúdo""" (**mais como criador de viciados**) colha parte desse lucro por ter conseguido fazer você clicar. Tudo isso é feito em busca de prazer. **Nessas plataformas, todos estão desesperados para permanecer relevantes, para conseguir aquela cenoura de mais um dólar.** Apesar da quantidade incrível de conteúdo, 99% do conteúdo enviado ali é produzido por desespero. Tudo nele é feito para transformar você em um viciado.

A mente humana não foi feita para receber tanto estímulo; você não foi feito para suportar o peso de [tudo em todo lugar ao mesmo tempo](https://en.wikipedia.org/wiki/Everything_Everywhere_All_at_Once). É demais para lidar em qualquer caso. (sim, vá assistir a essa obra-prima de filme; você entenderá exatamente o que significa sobrecarga mental e aonde ela pode levar)



![](the-opsec-bible/docs/productivity/the-poison-of-modern-times/eeao.jpeg)



## A realidade da internet morta ([vídeo sobre isso](https://www.youtube.com/watch?v=UnJKOYOkRMk))



![](the-opsec-bible/docs/productivity/the-poison-of-modern-times/image.png)
...
![](the-opsec-bible/docs/productivity/the-poison-of-modern-times/image-1.png)
...
![](the-opsec-bible/docs/opsec/the-quality-standard/117.png)
...
![](the-opsec-bible/docs/productivity/the-poison-of-modern-times/image-2.png)



As pessoas não fazem mais música; [pedem para a IA fazer música](https://www.youtube.com/watch?v=kIbWNXcYG0k) por elas:



![](the-opsec-bible/docs/productivity/the-poison-of-modern-times/image-3.png)
...
![](the-opsec-bible/docs/productivity/the-poison-of-modern-times/image-4.png)
...
![](the-opsec-bible/docs/productivity/the-poison-of-modern-times/image-5.png)



Sem mencionar [fazendas de bots](https://www.youtube.com/shorts/uX2awBEpMGU) sendo operadas e alugadas para quem tiver dinheiro para pagar pelos seus serviços.



![](the-opsec-bible/docs/productivity/the-poison-of-modern-times/image-6.png)





![](the-opsec-bible/docs/productivity/the-poison-of-modern-times/image-7.png)





![](the-opsec-bible/docs/productivity/the-poison-of-modern-times/image-8.png)
...
**Essencialmente apodrecendo e matando a internet inteira apenas para arrancar alguns trocados extras por desespero.**


## A razão por trás de por que as pessoas fazem as coisas

Preste atenção ao que as pessoas estão fazendo, **mas preste ainda mais atenção ao motivo pelo qual estão fazendo isso**. Quais são [as razões por trás das ações das pessoas](the-opsec-bible/docs/productivity/the-right-thing-to-do/index.md)?



![](the-opsec-bible/docs/productivity/the-right-thing-to-do/1.png)
...
![](the-opsec-bible/docs/productivity/the-poison-of-modern-times/pleasureseeking.png)
...
![](the-opsec-bible/docs/productivity/workspace-preparation/13.png)
...
Você precisa perceber que **a busca por prazer é um caminho de autodestruição.** Toda a alegria, luto, prazer, dor, tristeza, êxtase e tudo mais que você sentiu até agora, você experimentou dentro de si mesmo; você É capaz de gerá-los por conta própria e controlá-los, sem estímulo de fora. _Você deveria produzir esse bem-estar dentro de si mesmo,_ **a alegria e o bem-estar verdadeiros e duradouros jamais virão de fora; eles precisam vir de dentro de você.**
...
Vamos supor que você caiu no veneno das recentes eleições dos EUA. Você leu propaganda demais e se identificou com o partido de direita ou com o partido de esquerda (não importa com qual lado você se identificou), assumiu uma identidade; **a partir desse ponto o intelecto fará automaticamente de tudo para protegê-la.**



![](the-opsec-bible/docs/productivity/the-poison-of-modern-times/1.png)
...
**Das identidades às crenças, aos vícios. É tudo o mesmo veneno.** É isso que mantém você distraído, viciado, não realizado, miserável, infeliz, obediente e, em última instância, escravizado a um sistema que você não pediu, mas do qual é forçado a participar.

E ainda assim, por algum motivo, todos acreditam que isso é normal, não é? Por que eles toleram isso? Você precisa entender que **isso vem acontecendo há décadas,** devido à forma sistêmica como esse veneno foi espalhado pela mente de todos; as gerações que nasceram dentro dele são mais propensas a aceitá-lo como normal.
...
O veneno chegou à sua mente, **portanto é a sua mente que deve expulsar esse veneno**. A única maneira de se livrar desse veneno por meios naturais é usando seus pensamentos desta forma específica que descrevi [neste tutorial](the-opsec-bible/docs/productivity/nihilism/index.md).



![](the-opsec-bible/docs/productivity/the-poison-of-modern-times/2.png)
